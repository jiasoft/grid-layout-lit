...
class o {
    ...
    get styleSheet() {
        ...
        if (s && void 0 === t) {
            ...
            s && (t = e.get(i)),
                void 0 === t &&
                    ((this.i = t = new CSSStyleSheet()).replaceSync(this.cssText), s && e.set(i, t))
        }
        return t
    }
    toString() {
...
class $ extends HTMLElement {
    ...
    static finalize() {
        ...
        if (((this.finalized = !0), this.o(), this.hasOwnProperty(_('properties')))) {
    ...
    P(t, s) {
        ...
        if (void 0 !== e && !0 === i.reflect) {
            const o = (void 0 !== i.converter?.toAttribute ? i.converter : b).toAttribute(s, i.type)
            ;(this.m = t),
    ...
    requestUpdate(t, s, i, e = !1, o) {
        if (void 0 !== t) {
            if (
                ((i ??= this.constructor.getPropertyOptions(t)),
                !(i.hasChanged ?? S)(e ? o : this[t], s))
            )
                return
            this.C(t, s, i)
        }
    ...
    performUpdate() {
        ...
        try {
            ;(t = this.shouldUpdate(s)),
                t
                    ? (this.willUpdate(s), this.$?.forEach(t => t.hostUpdate?.()), this.update(s))
                    : this.M()
        } catch (s) {
            throw ((t = !1), this.M(), s)
        }
...
class Y {
    constructor({ strings: t, _$litType$: s }, i) {
        ...
        const r = t.length - 1,
            n = this.parts,
            [c, a] = X(t, s)
        if (((this.el = Y.createElement(c, i)), (K.currentNode = this.el.content), 2 === s)) {
                    ...
                    for (const t of e.getAttributeNames())
                        if (t.endsWith(x)) {
                            ...
                            n.push({
                                ...
                                name: r[2],
                                strings: i,
                                ctor: '.' === r[1] ? ot : '?' === r[1] ? ht : '@' === r[1] ? rt : et
                            }),
                                e.removeAttribute(t)
                        } else
                            t.startsWith(A) && (n.push({ type: 6, index: o }), e.removeAttribute(t))
                if (B.test(e.tagName)) {
                    ...
                    if (s > 0) {
                        ...
                        for (let i = 0; i < s; i++)
                            e.append(t[i], U()), K.nextNode(), n.push({ type: 2, index: ++o })
                        e.append(t[s], U())
                    }
                }
...
at?.(Y, it), (P.litHtmlVersions ??= []).push('3.1.0')
const lt = (t, s, i) => {
 ...
 */ class ut extends $ {
    constructor() {
        super(...arguments), (this.renderOptions = { host: this }), (this.ot = void 0)
    }
    createRenderRoot() {
    ...
    update(t) {
        ...
        this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
            super.update(t),
            (this.ot = lt(s, this.renderRoot, this.renderOptions))
    }
    connectedCallback() {
